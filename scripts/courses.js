...
const allLink = document.querySelector('#all-courses');
const cseLink = document.querySelector('#cse-courses');
const wddLink = document.querySelector('#wdd-courses');
...
cseLink.addEventListener('click', () => {
    const filteredCourses = courses.filter(course => course.subject.includes('CSE'));
    createCourseList(filteredCourses);
});

wddLink.addEventListener('click', () => {
    const filteredCourses = courses.filter(course => course.subject.includes('WDD'));
    createCourseList(filteredCourses);
});
